# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2020-12-09 07:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('httpport', models.CharField(max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ip', models.CharField(max_length=32)),
                ('websocketport', models.CharField(max_length=32)),
                ('max_memory', models.FloatField(default=1024)),
                ('message', models.TextField()),
                ('closed', models.BooleanField(default=True)),
                ('running', models.BooleanField(default=False)),
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service.Dataset')),
        ...
        migrations.AddField(
            model_name='gpu',
            name='rooms',
            field=models.ManyToManyField(to='service.RoomDB'),
        ),
        migrations.AddField(
            model_name='configfile',
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service.RoomDB'),
        ),
        migrations.AddField(
            model_name='account',
            name='accessdataset',
            field=models.ManyToManyField(to='service.Dataset'),
        ),
        migrations.AddField(
            model_name='account',
            name='accessroom',
        ...
        migrations.AddField(
            model_name='account',
            name='locate',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='location', to='service.RoomDB'),
        ),
        migrations.AddField(
            model_name='account',
